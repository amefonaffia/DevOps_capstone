...
Otherwise unsafe as it will not require password for ALL commands from the jenkins user,
...
* then update kubeconfig `aws eks --region us-east-2 update-kubeconfig --name capstonecluster` 
